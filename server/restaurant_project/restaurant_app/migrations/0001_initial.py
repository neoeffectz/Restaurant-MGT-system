...
>>>>>>> Stashed changes
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Menu.menuproducts')),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='ordered_items',
            field=models.ManyToManyField(through='restaurant_app.OrderItem', to='Menu.menuproducts'),
        ),
    ]
